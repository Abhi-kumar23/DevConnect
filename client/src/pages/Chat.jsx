...
const Chat = () => {
    ...
    return (
        <div className="h-[calc(100vh-8rem)] bg-white rounded-xl shadow-sm border overflow-hidden">
                    ...
                    {selectedChat ? (
                            ...
                            <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
                                {messages.length === 0 ? (
                                    ...
                                    messages.map((msg, idx) => (
                                        ...
                                        >
                                            <div
                                                className={`max-w-[70%] rounded-lg p-3 ${msg.sender?._id === user?._id || msg.sender === user?._id
                        ...
                        <div className="flex items-center justify-center h-full text-gray-500">
                            <div className="text-center">
                                ...
                                <p className="text-sm mt-2">Click on any conversation from the left sidebar</p>
                            </div>
                        </div>
                    )}
                </div>
